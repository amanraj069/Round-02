...
export function FeatureMilestones() {
  return (
    <div className="relative w-full h-full min-h-[420px] bg-[#f6e3f9] rounded-[32px] p-12 overflow-visible flex flex-col">
      ...
      <div className="flex-1 flex items-start justify-center my-12">
